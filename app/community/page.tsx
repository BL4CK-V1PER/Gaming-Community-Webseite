...
export const metadata: Metadata = { title: "Community", description: "Werte, Regeln und Einstieg bei Pixel-Rentner." };

const rules = [
  ["Respekt", "Behandle andere so, dass der nächste gemeinsame Abend weiterhin Spaß macht."],
  ["Fair Play", "Cheats, Exploits und absichtliches Stören haben bei Pixel-Rentner keinen Platz."],
    ...
    <div className="site-shell home-theme">
      ...
      <main>
        <section className="inner-hero" aria-labelledby="community-title">
          <div><p className="eyebrow"><span /> Pixel-Rentner Community</p><h1 id="community-title">Ein Ort zum Zocken.<br /><em>Kein Ort fürs Drama.</em></h1></div>
