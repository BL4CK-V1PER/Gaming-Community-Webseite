...
export const metadata: Metadata = { title: "Über uns", description: "Wofür NEXUS steht und wie unsere Gaming-Community wächst." };
    ...
    <div className="site-shell home-theme">
      ...
      <main>
        <section className="inner-hero" aria-labelledby="about-title">
          <div><p className="eyebrow"><span /> Über NEXUS</p><h1 id="about-title">Was uns verbindet?<br /><em>Die Leute dahinter.</em></h1></div>
          <p>NEXUS ist keine fertige Geschichte, die nur noch erzählt werden muss. Wir bauen sie gerade – mit jedem Match, jedem Serverabend und jedem neuen Mitglied.</p>
        </section>
        ...
        <section className="content-section split-story" aria-labelledby="story-title">
          ...
          <div className="prose-stack"><p>Aus getrennten Runden und Serverprojekten soll ein fester Treffpunkt werden. Counter-Strike 2 liefert den Wettkampf, SCUM die langen Geschichten – NEXUS verbindet beides.</p><p>Die Website ist dabei unsere Zentrale: Hier stehen Bereiche, Regeln, Serverinformationen und Ansprechpartner übersichtlich an einem Ort.</p><p>Was daraus wird, entscheidet nicht ein Marketingplan, sondern die Menschen, die mitmachen.</p></div>
        </section>
        ...
        <section className="timeline-console" aria-label="NEXUS Entwicklung">
        ...
        <section className="join-banner"><div><p className="eyebrow"><span /> Deine Geschichte gehört dazu</p><h2>Mach NEXUS zu deinem Treffpunkt.</h2></div><div><p>Mehr über Regeln, Einstieg und Community findest du im Community-Bereich.</p><a className="button button-primary" href="/community/">Zur Community <span>→</span></a></div></section>
      </main>
      <SiteFooter />
    </div>
  );
